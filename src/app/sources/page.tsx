  ...
  return (
    <div className="section">
      <section className="hero">
        ...
        <p className="lede">Every company page points back to external sources so readers can verify the research process rather than treating the platform as a black box.</p>
      </section>
