export default function DisclaimerPage() {
  return (
    <div className="section">
      <section className="hero"><div className="eyebrow">Legal</div><h1>Disclaimer</h1><p className="lede">ResponsibleWealth is a public research and educational platform. It does not provide personalized investment advice, portfolio management, or brokerage services.</p></section>
